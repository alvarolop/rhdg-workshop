...
In such case, I strongly recommend you check the following GitHub repository where we have an example application and all the Openshift resources to deploy a RHDG client in a few steps: https://github.com/alvarolop/rhdg8-client#42-run-it-on-openshift
