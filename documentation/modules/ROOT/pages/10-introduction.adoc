...
Welcome to the *"Infinispan Infrastructure" workshop*! In this chapter, we will explore the significance of caches through the captivating story of an application dedicated to the best books in history.
