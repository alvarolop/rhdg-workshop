...
In order to check the laboratory environment, please access the Openshift Console via browser using your credentials. The instructor will provide you the URL.
